...
public class DemoEmployee {
	...
	public static void main(String[] args) {
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints "PART TIME EMPLOYEE" because the method is overriden in the PartTimeEmployee class because it was upcasted 
		// emp3.getHourlyRate(); // returns syntax error because it is not defined in the Employee class.
		...
		// This instruction returns a ClassCastException at run time because it is attempting to downcast an Employee object to PartTimeEmployee.
